...
model.compile(optimizer = adam, loss = 'categorical_crossentropy', metrics = ['accuracy'])# Categorical cross entropy caso não seja binary
...
#plt.plot(model.history.history['mean_acc'])
   ...
   #plt.show()
model.save_weights('try1024_.h5')
model.save('try1024.h5')
